<%@ Page Title="Document Imaging" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DocumentImporter._Default" %>

<%--<%@ Register Assembly="GdPicture.NET.14.WEB.DocuVieware" Namespace="GdPicture14.WEB" TagPrefix="cc1" %>--%>
<%@ Register Assembly="GdPicture.NET.14.WEB.DocuVieware" Namespace="GdPicture14.WEB" TagPrefix="cc2" %>


<%-- 
    5/9/17
    Added Toolbar, js & css files.
    

    Eval Key GDPictures 14
    0419207224848486358422032
    --%>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <link href="style/cleanUp_style.css" rel="stylesheet" type="text/css" />
    ...
    <div class="jumbotron">
        <h1>Document Imaging Web Application</h1>
        <p class="lead">Open a Docx, PDF, Image, TXT file. View, Manipulate and Save the file in PDF and/or TIFF format.</p>
        <p class="lead">To learn the features and functionality, <a href="About.aspx">Click Here</a> </p>        
    </div>

       <!-- Currently, DocuVieware supports only PDF & Tiff file formats to be exported.  
            EnableFormFieldsEdition - Forms fields can be edited in browser or not
           CollapsedSnapIn - Don't want to see the Thumbnails panel at start of prg
           EnableGdPictureAnnotations - Don't want to add Annotations
    ...
    <div>
        ...
        <p style="float: right; font-weight: bold; font-style: italic">
            &nbsp;<asp:Label ID="docNameLbl" Text="" runat="server"></asp:Label> 
        </p>
        ...
        <nav id="navigation" role="navigation">
            ...
            <div class="pts pbs line" id="container">
                ...
                <div class="filters">
                    <!-- Crop Black Border -->
                    <div id="btn_RemoveBlackBorders" class="filter" title="Crop Black Borders" onclick="return applyFilter('automaticRemoveBlackBorders');">
                        <div class="icon">
                        ...
                        <span class="filter_name">Crop Black Borders</span>
                    </div>
        ...
        <div class="dv-viewer">
            ...
            <cc2:DocuVieware ID="docuView" runat="server" Height="750px" Width="1140px"
                AllowedExportFormats="*"
                CollapsedSnapIn="true"
                EnableGdPictureAnnotations="true"
                ShowAnnotationsSnapIn="false"
                ShowTextSearchSnapIn="false"
                OnNewDocumentLoaded="docuView_NewDocumentLoaded" OnUnload="docuView_Unload"
            ...
            <div class="toolbar_hover">
                <div class="toolbar_container">
                    ...
                    <div class="toolbar_buttons">
                        ...
                        <div class="toolbar_item" title="Open" onclick="loadFromFile();">
                        ...
                        <div class="toolbar_item" title="Load from URI" onclick="$('#document_uri_area').slideDown();">
                            <svg width="28" height="28" viewBox="0 0 512 512">
                         ...
                         <!--   Scan File  -->
                        <div class="toolbar_item" title="TWAIN" onclick="acquireTwain();"  >
                            <svg width="28" height="28" viewBox="0 0 512 512">
                                <g>
                                    <circle cx="51.965" cy="359.677" r="11.701" />
                                    <circle cx="81.385" cy="359.677" r="11.701" />
                                    <circle cx="110.807" cy="359.677" r="11.701" />
                                    <g>
                                        <path d="M 1.511 422.8 M 490.943 306.374 H 1.511 v 117.16 H 39.23 v 41.256 h 436.274 v -38.583 c 0 0 11.455 0.644 15.075 0 H 512 V 306.374 h -9.464 M 494.957 323.509 c 1.806 16.449 0 74.392 0 74.392 c -2.007 9.359 -9.361 7.799 -9.361 7.799 h -31.465 v 40.232 H 58.089 v -40.232 h -25.85 c -8.693 0 -10.323 -6.271 -10.698 -9.807 c -1.585 -14.96 -0.264 -57.357 0 -72.401" />
                                        <path d="M 458.846 307.186 l -0.516 -0.217 L 196.719 80.491 l 25.868 -29.177 L 512 296.5 l -9.464 10.687 c 0 0 -2.014 -3.027 3.563 5.432" />
                                    </g>
                                </g>
                            </svg>
                        </div>
                        ...
                        <!-- Save the File -->
                        <div class="toolbar_item" id="bt_save" title="Save" onclick="saveFile();" >
                            <svg width="28" height="28" viewBox="0 0 512 512">
                                <polygon points="358.605,293.73 339.798,274.681 270,344.721 270,0 243,0 243,344.724 172.732,274.681 153.577,293.73 256.097,396.291"></polygon>
                                <path d="M 431.5 363.771 c -7.446 0 -13.5 6.025 -13.5 13.472 V 485 H 94 V 377.242 c 0 -7.446 -6.054 -13.472 -13.5 -13.472 S 67 369.796 67 377.242 v 121.241 C 67 505.93 73.471 512 80.917 512 h 350.254 c 7.446 0 13.829 -6.07 13.829 -13.517 V 377.242 C 445 369.796 438.946 363.771 431.5 363.771 Z"></path>
                            </svg>
                        </div>
                        <!-- print button -->
                        <div class="toolbar_item" id="bt_print" onclick="printFile()">
                            <svg width="28" height="28" viewBox="0 0 512 512">
                        ...
                        <div class="toolbar_item" id="bt_select_page_prev" title="Previous" onclick="if(isEnabled($(this))){previousPage()};">
                            <svg width="28" height="28" viewBox="0 0 512 512">
                                <path d="M 256.001,0.00L0.00,256.00L 160.00,256.00L 160.00,511.999L 352.00,512.00L 352.00,256.00L 512.00,256.00 z"></path>
                            </svg>
                        </div>
                        <!-- page next button -->
                        <div class="toolbar_item" id="bt_select_page_next" title="Next" onclick="if(isEnabled($(this))){nextPage()};">
                            <svg width="28" height="28" viewBox="0 0 512 512">
                        ...
                        <div class="group_separator"></div>
                        <!-- zoom out button -->
                        <div class="toolbar_item" id="bt_zoom_out" title="Zoom Out" onclick="if(isEnabled($(this))){zoomOut()};">
                            <svg width="28" height="28" viewBox="0 0 512 512">
                        ...
                        <!-- zoom in button -->
                        <div class="toolbar_item" id="bt_zoom_in" title="Zoom In" onclick="if(isEnabled($(this))){zoomIn()};">
                            <svg width="28" height="28" viewBox="0 0 512 512">
                        ...
                        <div class="group_separator"></div>
                        <!-- Rotate Left -90 -->
                        <div class="toolbar_item" id="bt_RotateM90" title="Rotate -90" onclick="if(isEnabled($(this))){applyRotate('rotateM90')};">
                            <svg width="28" height="28" viewBox="0 0 512 512">
                                <path d="M 434.071 74.568 c -91.884 -91.862 -236.665 -99.59 -337.407 -22.91 L 54.759 9.743 L 32.226 144.674 l 134.885 -22.554 l -38.225 -38.233 c 82.86 -59.308 199.111 -51.707 273.321 22.544 c 82.693 82.67 82.693 217.226 0 299.962 l 31.863 31.865 C 534.322 337.96 534.322 174.819 434.071 74.568 Z M 80.284 440.457 c 11.816 11.441 24.821 21.739 38.661 30.718 l 24.47 -37.847 c -11.376 -7.35 -22.071 -15.844 -31.797 -25.26 L 80.284 440.457 Z M 47.806 262.881 L 2.74 263.982 c 0.418 16.457 2.419 32.963 5.985 48.98 l 44.009 -9.77 C 49.786 289.991 48.136 276.435 47.806 262.881 Z M 65.322 341.745 l -41.236 18.22 c 6.624 15.006 14.765 29.486 24.182 42.997 l 36.967 -25.79 C 77.468 366.038 70.779 354.155 65.322 341.745 Z M 338.087 450.402 l 17.604 41.458 c 15.138 -6.426 29.707 -14.348 43.349 -23.547 l -25.263 -37.319 C 362.554 438.565 350.542 445.077 338.087 450.402 Z M 162.823 493.797 c 15.315 6.116 31.267 10.735 47.441 13.729 l 8.229 -44.273 c -13.291 -2.466 -26.382 -6.249 -38.948 -11.267 L 162.823 493.797 Z M 258.872 466.774 l 0.525 45.064 c 16.592 -0.177 33.097 -1.979 49.073 -5.281 l -9.155 -44.095 C 286.202 465.146 272.559 466.599 258.872 466.774 Z"></path>
                            </svg>
                        </div>
                        <!-- Rotate Right +90 -->
                        <div class="toolbar_item" id="bt_RotateP90" title="Rotate +90" onclick="applyRotate('rotateP90');">
                            <svg width="28" height="28" viewBox="0 0 512 512">
                                
                                <path d="M429 1735 c-15 -8 -29 -24 -32 -36 -3 -12 -2 -97 3 -188 5 -91 16 -310 25 -486 33 -692 45 -887 55 -906 27 -49 29 -49 644 -49 413 0 582 3 600 12 56 25 54 13 86 676 16 339 34 688 40 776 10 165 7 186 -30 206 -12 6 -251 10 -692 10 -563 -1 -677 -3 -699 -15z m370 -196 c23 -25 24 -46 45 -744 14 -460 14 -481 -3 -505 -24 -33 -82 -39 -110 -11 -25 25 -28 60 -41 541 -6 217 -13 461 -17 542 l-6 146 26 26 c32 32 78 34 106 5z m379 1 l22 -21 0 -606 0 -607 -22 -23 c-28 -30 -80 -31 -108 -1 -20 21 -20 32 -20 630 0 595 0 608 20 628 26 26 80 26 108 0z m384 -10 c18 -24 18 -40 0 -620 -13 -414 -22 -602 -30 -617 -23 -43 -99 -42 -126 0 -13 19 -12 98 4 617 11 327 20 598 20 603 0 4 9 16 21 28 28 28 85 23 111 -11z"></path>
                                     -->
                        ...
                        <div class="toolbar_item" id="bt_CloseDoc" title="Close Doc" onclick="closeDocument();">
                            <svg width="28" height="28" viewBox="0 0 512 512">
                                <path d="M13 254 c-4 -10 11 -32 43 -65 l48 -49 -43 -44 c-29 -29 -42 -50 -38 -60 10 -25 28 -19 74 26 l43 42 43 -42 c46 -45 64 -51 74 -26 4 10 -9 31 -38 60 l-43 44 47 48 c50 50 57 69 31 79 -10 4 -32 -11 -65 -43 l-49 -48 -48 47 c-50 50 -69 57 -79 31z"></path>
                            </svg>
                        </div>
    ...
    <script>
        ...
        function addTimestamp() {
            DocuViewareAPI.PostCustomServerAction("docuView", true, "addTimestamp");
        }
        // This function is called upon "Signature" button click
        function addSignature() {
            DocuViewareAPI.PostCustomServerAction("docuView", true, "addSignature");
        }

        function addApprovedStamp() {
            DocuViewareAPI.PostCustomServerAction("docuView", true, "addApprovedStamp");
        }

        function addRejectedStamp() {
            DocuViewareAPI.PostCustomServerAction("docuView", true, "addRejectedStamp");

        }

        // This function is called on window.load event
        function RegisterOnNewDocumentLoadedOnDocuViewareAPIReady() {
            if (typeof DocuViewareAPI !== "undefined" && DocuViewareAPI.IsInitialized("docuView")) {
                DocuViewareAPI.RegisterOnNewDocumentLoaded("docuView", function () {

                    /*
                    if (DocuViewareAPI.GetDocumentType("docuView") != DocumentType.DocumentTypeOpenXMLWord &&
                        DocuViewareAPI.GetDocumentType("docuView") != DocumentType.DocumentTypePDF &&
                        DocuViewareAPI.GetDocumentType("docuView") != DocumentType.DocumentTypeBitmap &&
                        DocuViewareAPI.GetDocumentType("docuView") != DocumentType.DocumentTypeTXT) {

                        DocuViewareAPI.PostCustomServerAction("docuView", true, "UnsupportedFile");
                    ...
                    DocuViewareAPI.SelectSnapIn("docuView", "LeaveRequestApprovalSnapIn");
                    //alert("Loaded File : " + DocuViewareAPI.GetDocumentName("docuView"));
                    document.getElementById('<%=docNameLbl.ClientID%>').innerHTML = DocuViewareAPI.GetDocumentName("docuView");
                });
            }
            else {
        ...
        function closeDocument() {
            //DocuViewareAPI.PostCustomServerAction("docuView", true, "CloseDoc");
